...
public class WebMessagingMessageEntityList  implements Serializable {
  ...
  /**
   **/
  public WebMessagingMessageEntityList entities(List<WebMessagingMessage> entities) {
  ...
  public List<WebMessagingMessage> getEntities() {
    return entities;
  }
  public void setEntities(List<WebMessagingMessage> entities) {
    this.entities = entities;
  }
