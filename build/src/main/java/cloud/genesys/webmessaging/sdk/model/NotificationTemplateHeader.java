...
public class NotificationTemplateHeader extends HashMap<String, Object> implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(media, parameters, text, type, super.hashCode());
  }
