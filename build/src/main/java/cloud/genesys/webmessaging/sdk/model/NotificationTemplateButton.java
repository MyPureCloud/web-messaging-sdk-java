...
public class NotificationTemplateButton extends HashMap<String, Object> implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(index, parameters, phoneNumber, text, type, url, super.hashCode());
  }
