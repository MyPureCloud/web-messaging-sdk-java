...
public class WebMessagingQuickReply  implements Serializable {
 ...
 @JsonDeserialize(using = ActionEnumDeserializer.class)
   ...
   **/
  public WebMessagingQuickReply payload(String payload) {
   ...
   **/
  public WebMessagingQuickReply image(String image) {
    this.image = image;
    return this;
  }
   ...
   * Specifies the type of action that is triggered upon clicking the quick reply.
   **/
  public WebMessagingQuickReply action(ActionEnum action) {
    this.action = action;
    return this;
  }
